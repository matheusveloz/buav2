-- ========================================
-- APLICAR FUNÇÃO DE DESCONTO ATÔMICO DE CRÉDITOS
-- ========================================
-- Este arquivo resolve o bug de race condition quando múltiplos vídeos
-- são processados simultaneamente.
--
-- PROBLEMA:
-- Quando 3 vídeos são processados ao mesmo tempo, apenas o último desconto
-- era mantido, sobrescrevendo os anteriores.
--
-- EXEMPLO DO BUG:
-- Usuário com 100 créditos processa:
-- - Vídeo 1: 50s = 51 créditos
-- - Vídeo 2: 12s = 13 créditos  
-- - Vídeo 3: 12s = 13 créditos
-- Total esperado: 77 créditos
-- Total cobrado (BUG): 51 créditos (apenas o último)
--
-- SOLUÇÃO:
-- Usar função RPC com FOR UPDATE para bloquear a linha durante a transação
-- garantindo que apenas uma requisição processe por vez (operação atômica)
-- ========================================
